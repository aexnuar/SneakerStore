...
struct Sneaker: Equatable, Codable {
    let id, brand, sneaker, price: String
...
//            Sneaker(brand: "Rick Owens", sneaker: "Кожаные кеды Hollywood Jumbolace", price: "114 000", sizesAvailable: [.size40, .size41, .size42, .size43], sneakerImages: ["RickOwens-1", "RickOwens-2", "RickOwens-3", "RickOwens-4", "RickOwens-5", "RickOwens-6", "RickOwens-7"]),
